...
public class BatchController {
	...
	@GetMapping("batch/{id}")
	public ResponseEntity<?> getBatchSubjectById(@PathVariable("id") String batchId){
		try {
	...
	public ResponseEntity<?> getTestData(){
		...
		course.setCourseCode("ABCD");
		course.setCourseCreated(LocalDateTime.now());
		course.setCourseDescription("ABCD Course Desc");
		course.setSchoolId(1001L);
		course.setCourseId("ABCD Id");
		b.setCourse(course);
		return new ResponseEntity<>(b, HttpStatus.OK);
	}//EndOfTest()
